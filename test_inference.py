...
# accelerate launch --num_processes 8 test_inference.py \
# --lora_path /workspace/pangyunhe/source_code/finetune_basemodel_demo/2024-1-5latest/checkpoint-2250 > inference.log
...
if accelerator.is_main_process: 
    ...
    acc, f1 = compute_metric(eval_data,res_list)
    res_write = {
        'acc':acc,
        'f1':f1,
        'lora_path':lora_path,
    ...
    with open(f'./eval_result/result.json', 'a+') as f:
