...
PUB_PATH=/workspace/pangyunhe/dataset/whoiswho/train_pub.json
TRAIN_PATH=/workspace/pangyunhe/source_code/finetune_basemodel_demo/dataset/train_data.json
DATESTR=`date +%Y%m%d-%H%M%S`
OUTPUT_DIR=/workspace/pangyunhe/source_code/finetune_basemodel_demo/output/${RUN_NAME}-${DATESTR}-${LR}
